      ...
      <div class="col-12">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{ isset($transaksi) ? 'Form Edit Gerbong' : 'Form Tambah Gerbong' }}</h6>
          </div>
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="berat_cucian" name="berat_cucian" value="{{ isset($transaksi) ? $transaksi->berat_cucian : '' }}">
            </div>
          </div>
